...
```text
GitHub release tag                                      v0.1.21
VERSION                                                 0.1.21
custom_components/notify_studio/manifest.json           0.1.21
custom_components/notify_studio/const.py                 0.1.21
panel-src/package.json                                   0.1.21
README badge and frontend cache version                  0.1.21
```
