...
```text
GitHub release tag                                      v0.1.26
VERSION                                                 0.1.26
custom_components/notify_studio/manifest.json           0.1.26
custom_components/notify_studio/const.py                 0.1.26
panel-src/package.json                                   0.1.26
README badge and frontend cache version                  0.1.26
```
